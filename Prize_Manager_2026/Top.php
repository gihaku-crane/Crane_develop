...
$stmt_up->execute([$next_week_start->format('Y-m-d'), $next_week_end->format('Y-m-d')]);
$upcoming_prizes = $stmt_up->fetchAll(PDO::FETCH_ASSOC);
...
<html lang="ja">
    ...
    <body>
        <?php 
        // 共通ヘッダーの出力。引数 'home' によりナビゲーションの「HOME」をアクティブ表示にする
        output_header('home');
        ?>
